-- Carry the fiber floor marker through the batch-portion logging RPC.
--
-- A portion of a batch whose fiber is a floor is itself a floor, so the flag
-- rides along with the scaled value. Signature, argument order, security mode
-- and search_path are unchanged from migrations 007/029.
